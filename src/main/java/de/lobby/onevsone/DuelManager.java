...
import java.util.*;
/**
 * Die Klasse DuelManager verwaltet die Warteschlange und die aktiven Duelle zwischen Spielern.
 * * Sie ermöglicht es Spielern, sich in eine Warteschlange einzureihen, um gegen andere Spieler zu kämpfen.
...
public class DuelManager {
    ...
    public DuelManager(LobbyManager lobbyManager, Location spawn1, Location spawn2) {
        lobbySystemMain = JavaPlugin.getPlugin(LobbySystemMain.class);
        this.lobbyManager = lobbyManager;
        this.spawn1 = LocationUtil.loadLocation(this.lobbySystemMain, "duel.spawn1");;
        this.spawn2 = LocationUtil.loadLocation(this.lobbySystemMain, "duel.spawn2");
    }
